<p align="center">
  ...
  <img src="https://img.shields.io/badge/v1.8.0-Latest-orange?style=flat-square" />
  <img src="https://img.shields.io/badge/v1.8.0-Latest-orange?style=flat-square" />
</p>

<h1 align="center">WindsurfGodTools</h1>
...
```bash
git clone https://github.com/IBaiKe/WindsurfGodTools.git
cd WindsurfGodTools
...
```bash
npm install -g pm2
pm2 start src/index.js --name windsurfgodtools --cwd /path/to/WindsurfGodTools
...
[Unit]
Description=WindsurfGodTools
After=network.target

[Service]
Type=simple
User=windsurf
WorkingDirectory=/opt/WindsurfGodTools
...
Client (OpenAI SDK / Anthropic SDK / curl / Cursor / Aider)
   │
   ▼
WindsurfGodTools  (Node.js HTTP, :3003)
