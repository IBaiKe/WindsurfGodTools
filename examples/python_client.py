"""
WindsurfGodTools - Python 客户端示例
=================================

三种用法：
  1. 原生 OpenAI SDK（推荐） - 把 base_url 指向 WindsurfGodTools 即可
...
def example_openai_sdk():
    ...
    resp = client.chat.completions.create(
        model="gpt-4o-mini",
        messages=[{"role": "user", "content": "用一句话介绍 WindsurfGodTools"}],
    )
