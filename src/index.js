/**
 * [INPUT]: config.js 配置/日志/版本, auth.js 认证池, langserver.js LS 管理, server.js HTTP 服务
 * [OUTPUT]: BRAND 品牌常量, VERSION 版本号 (re-export from config.js)
 * [POS]: 进程入口，启动 LS + HTTP 服务器，信号处理
...
export { VERSION };
export const BRAND = 'WindsurfGodTools';
...
`;
  console.log(banner);
  console.log(`  OpenAI-compatible proxy for Windsurf\n`);
