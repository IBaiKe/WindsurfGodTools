...
echo ╔══════════════════════════════════════════╗
echo ║  WindsurfGodTools v2.0 Installer (Windows)    ║
echo ╚══════════════════════════════════════════╝
echo.
...
if not exist "%INSTALL_DIR%\.env" (
    echo # WindsurfGodTools configuration> "%INSTALL_DIR%\.env"
...
echo echo Installing WindsurfGodTools as Windows Service...>> "%INSTALL_DIR%\install-service.bat"
echo echo Requires NSSM ^(https://nssm.cc/^). Download and put nssm.exe in PATH.>> "%INSTALL_DIR%\install-service.bat"
echo nssm install WindsurfGodTools node "%INSTALL_DIR%\src\index.js">> "%INSTALL_DIR%\install-service.bat"
echo nssm set WindsurfGodTools AppDirectory "%INSTALL_DIR%">> "%INSTALL_DIR%\install-service.bat"
echo nssm set WindsurfGodTools Start SERVICE_AUTO_START>> "%INSTALL_DIR%\install-service.bat"
echo nssm start WindsurfGodTools>> "%INSTALL_DIR%\install-service.bat"
echo echo Done!>> "%INSTALL_DIR%\install-service.bat"
echo pause>> "%INSTALL_DIR%\install-service.bat"

echo.
echo ════════════════════════════════════════════
echo ✅ WindsurfGodTools v2.0 installed!
echo.
